    ...
    def Reg1(self):
        ...
        for i in Liste:
           # if (self.Dossier != i.id) and  (self.ImmatriculationAdverse not in [None,""] and len(i.Immatriculation) not in [1,2,3]) and( Preprocessing_Imm(i.Immatriculation) == self.ImmatriculationAdverse or Preprocessing_Imm(i.ImmatriculationAdverse) == self.ImmatriculationAdverse) and ((i.Statutgarage is not  None) and (i.Statutgarage.lower()=="cas douteux")):
            if (self.Immatriculation not in [None,""] and self.ImmatriculationAdverse not in [1,2,3]) and( Preprocessing_Imm(i.Immatriculation) == self.ImmatriculationAdverse or Preprocessing_Imm(i.ImmatriculationAdverse) == self.ImmatriculationAdverse) and ((i.Statutgarage is not  None) and (i.Statutgarage.lower()=="cas douteux")):
